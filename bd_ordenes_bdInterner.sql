...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-03-2019 a las 03:20:28
...
--
-- Volcado de datos para la tabla `detalle_producto_menu`
--

INSERT INTO `detalle_producto_menu` (`det_codigo`, `ped_codigo`, `prm_nombre`, `fac_codigo`, `det_especificaciones`, `det_cantidad`, `prm_codigo`, `precio`, `seccion`) VALUES
(1, 79, 'Ensalada Cuencana', NULL, 'asjhbbd', 1, NULL, 3.50, 'cocina');
...
(79, 5, 'RECIBIDO', NULL, '2019-03-18 19:07:08', NULL, NULL),
(80, 7, 'RECIBIDO', NULL, '2019-03-18 19:14:28', NULL, NULL),
(81, 7, 'RECIBIDO', NULL, '2019-03-18 19:14:32', NULL, NULL),
(82, 7, 'RECIBIDO', NULL, '2019-03-20 11:18:55', NULL, NULL),
(83, 7, 'RECIBIDO', NULL, '2019-03-20 11:18:57', NULL, NULL);
...
(1, 1, 'Mesero', 'jcaguana1', 'Caguana28'),
...
--
ALTER TABLE `detalle_producto_menu`
  MODIFY `det_codigo` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `pedido`
  MODIFY `ped_codigo` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=84;
--
