...
public class Empleados extends Conexion {
    ...
    public String buscarNombreApellidoEmpleado(int codigoEmpleado) {
        PreparedStatement ps = null;
        ResultSet rs = null;
        Connection conexion = getConexion();
        String nombre = "";
        String query = "SELECT emp_nombre,emp_apellido FROM empleado WHERE emp_codigo = '" + codigoEmpleado + "' LIMIT 1;";
        try {
            ps = conexion.prepareStatement(query);
            rs = ps.executeQuery();
            if (rs.next()) {
    ...
    public String buscarIdEmpleado(int codigoEmpleado) {
        PreparedStatement ps = null;
        ResultSet rs = null;
        Connection conexion = getConexion();
        String id = "";
        String query = "SELECT emp_id FROM empleado WHERE emp_codigo = '" + codigoEmpleado + "' LIMIT 1;";
        try {
            ps = conexion.prepareStatement(query);
            rs = ps.executeQuery();
            if (rs.next()) {
    ...
    public String buscarDireccionEmpleado(int codigoEmpleado) {
        PreparedStatement ps = null;
        ResultSet rs = null;
        Connection conexion = getConexion();
        String direccion = "";
        String query = "SELECT emp_direccion FROM empleado WHERE emp_codigo = '" + codigoEmpleado + "' LIMIT 1;";
        try {
            ps = conexion.prepareStatement(query);
            rs = ps.executeQuery();
            if (rs.next()) {
    ...
    public String buscarTelefonoEmpleado(int codigoEmpleado) {
        PreparedStatement ps = null;
        ResultSet rs = null;
        Connection conexion = getConexion();
        String telefono = "";
        String query = "SELECT emp_telefono FROM empleado WHERE emp_codigo = '" + codigoEmpleado + "' LIMIT 1;";
        try {
            ps = conexion.prepareStatement(query);
            rs = ps.executeQuery();
            if (rs.next()) {
    ...
    public String buscarCorreoEmpleado(int codigoEmpleado) {
        PreparedStatement ps = null;
        ResultSet rs = null;
        Connection conexion = getConexion();
        String correo = "";
        String query = "SELECT emp_correo FROM empleado WHERE emp_codigo = '" + codigoEmpleado + "' LIMIT 1;";
        try {
            ps = conexion.prepareStatement(query);
            rs = ps.executeQuery();
            if (rs.next()) {
